...
export default function Home() {
  ...
  return (
    <div>
      <Jumbotron title="Hello World" subTitle="Welcome to React E-commerce" style={{ marginTop: "-20px" }} />
      ...
      <div className="container text-center p-5">
        {products && products.length < total && (
          <Button
            ...
            style={{ width: "50%", backgroundColor: "#ffd700", borderColor: "#ffd700", color: "#000" }}
          >
